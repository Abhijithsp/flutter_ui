...
class HealthCareDetails extends StatefulWidget {
  @override
  _HealthCareDetailsState createState() => _HealthCareDetailsState();
}

class _HealthCareDetailsState extends State<HealthCareDetails> {
  int counter = 0;
  bool isAdded = false;
